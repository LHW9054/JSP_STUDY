...
<h3>JSP에서 자주 사용되는 작동을 태그 형식으로 만든 체계</h3>
...
<table>
	...
	<tr>
		...
		<td>
			...
			내부태그로 &lt;jps:param name="" value="" />를 이용하여<br>
			추가 파라미터를 전달할 수도 있다
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			대상이 되는jsp를 실행한 후 만들어지는 최종 응답만 포함시키므로<br>
...
<h3>ob.age<jsp:getProperty name="ob" property="name" /></h3>
